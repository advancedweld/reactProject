...
import { User, GetUsersResponse, UserDetailsersResponse } from './type'
...
export const fetchUserDetail: (params: { userId: string }) => Promise<UserDetailsersResponse> = (params) => request.post('/api-x/user/detail', params)
